    ...
    def get_transition_matrix(
        ...
        for s in S:
            for a in A:
                ...
                flip_prob = 1.0 - follow_prob

                next_follow = self.get_next_state(int(s), int(a))
                next_flip = self.get_next_state(int(s), int(1 - a))

                T[s, a, next_follow] += follow_prob
                T[s, a, next_flip] += flip_prob
